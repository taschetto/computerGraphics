...
void InitialState::ReshapeFunc(GameEngine*, GLsizei width, GLsizei height)
{
}

void InitialState::MotionFunc(GameEngine*, int x, int y)
{
}

void InitialState::MouseFunc(GameEngine*, int button, int state, int x, int y)
{
}